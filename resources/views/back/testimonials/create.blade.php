...
@section('title')
    <title>{{ config('app.name') }} | New Testimonial</title>
@endsection
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h4 class="title">Add New Testimonials</h4>
                        </div>
                        <div class="content">
                            {{ Form::open(['method' => 'post', 'route' => 'testimonials.store', 'files' => true]) }}
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        {{ Form::textarea('testimony', null, ['class' => 'form-control', 'id' => 'testimony', 'placeholder' => 'Enter Testimony', 'rows' => '5', 'cols' => '80', 'style' => 'resize:none;', 'required' ]) }}
                                    </div>
