        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="header">
                            <h4 class="title">Edit Success Story of "<b>{{ $story->name }}</b>"</h4>
                        </div>
                        <div class="content">
                            {{ Form::model($story, ['method' => 'patch', 'route' => ['stories.update', $story->id], 'files' => true]) }}
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <img id="img" src="{{ asset('public/img/success_stories') }}/{{ $story->avatar}}" alt="user avatar"
