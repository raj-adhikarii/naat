...
@section('title')
    <title>{{ config('app.name') }} | Level 3 Advanced Diploma in International Tourism</title>
@endsection
    ...
    <section id="page-title" data-parallax-image="{{ asset('public/img/training-hero.jpg') }}">
        <div class="container">
            <div class="page-title">
                <h1>Level 3 Advanced Diploma in International Tourism</h1>
            </div>
                    ...
                    <div id="blog" class="single-post">
                        <div class="post-item">
                            <div class="post-item-wrap">
                                ...
                                <br>
                                <p style="text-align: justify;"><strong> LEVEL 3 ADVANCED DIPLOMA IN INTERNATIONAL TOURISM:</strong></p>
                                <p style="text-align: justify;">
                                   Tourism is one of the largest and fast booming global industries worth trillions of dollars.
                                    ...
                                    Since the tourism industry itself is so large and diverse, there are many opportunities 
                                    in terms of career choices for those looking to grow and develop themselves in this field.
                                     So, Diploma in International Tourism course is designed to train interested students to
                                      prepare them for a career in tourism and related industries.

                                    </p>
                                    <strong>WHY LEVEL 3 ADVANCED DIPLOMA IN INTERNATIONAL TOURISM</strong>
                                    <p>Tourism is a vast industry that easily crosses over to multiple other domains like 
                                        aviation and hospitality. Having a Level 3 Diploma in International Tourism will 
                                        not only prepare you for a career in one of these industries but also provide you
                                         with a perspective on how different disciplines come together as a business whose
                                          main goal is economic benefit.
                                        Some of the lucrative career options for the students with Level 3 Diploma in 
                                        International Tourism include tour guide, travel agent, sales and marketing manager, 
                                        public relations officer and tour planner among others.</p>
                                    ...
                                    <p style="text-align: justify;"><strong>CAREER OPPORTUNITIES:</strong></p>
                                     ...
                                     <p style="text-align: justify;"><span style="font-size: 12.16px;">18 months</span></p>
                                     ...
                                     <p style="text-align: justify;"><span style="font-size: 12.16px;">9.The Tourism Industry- Social and economic factors</span></p>
                                     <p style="text-align: justify;"><span style="font-size: 12.16px;">10.Managing people</span></p>
                                     <p style="text-align: justify;"><span style="font-size: 12.16px;">11.Strategic Customer services</span></p>
                                     <p style="text-align: justify;"><span style="font-size: 12.16px;">12.Financial control</span></p>
                                     <p style="text-align: justify;"><span style="font-size: 12.16px;">13.Marketing Tourism</span></p>
                                     <p style="text-align: justify;"><span style="font-size: 12.16px;">14.Managing Operations and Information</span></p>
                            </div>
                        </div>
                    </div>
                </div>
