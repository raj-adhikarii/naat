...
@section('title')
    <title>{{ config('app.name') }} | Consultation on Aircraft Maintenance Engineering (AME)</title>
@endsection
    ...
    <section id="page-title" data-parallax-image="{{ asset('public/img/training-hero.jpg') }}">
        <div class="container">
            <div class="page-title">
                <h1>Consultation on Aircraft Maintenance Engineering (AME)</h1>
            </div>
            <div class="breadcrumb">
                <ul>
                    <li><a href="{{ asset('/') }}">Home</a> </li>
                    <li><a href="#">Consultation on Aircraft Maintenance Engineering (AME)</a> </li>
                </ul>
            </div>
        </div>
    </section>
                    ...
                    <div id="blog" class="single-post">
                        <div class="post-item">
                            <div class="post-item-wrap">
                                ...
                                <br>
                                <p style="text-align: justify;"><strong>CONSULTATION ON AIRCRAFT MAINTENANCE ENGINEERING (AME):</strong></p>
                                <p style="text-align: justify;">
                                   NAAT provides consultation on Aircraft Maintenance Engineering (AME) from
                                    reputed institutions around the globe.
                                    </p>
