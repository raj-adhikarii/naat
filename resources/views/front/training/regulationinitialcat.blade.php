...
@section('title')
    <title>{{ config('app.name') }} | Dengerous Goods Regulation (DGR) Initial Category 3</title>
@endsection
    ...
    <section id="page-title" data-parallax-image="{{ asset('public/img/training-hero.jpg') }}">
        <div class="container">
            <div class="page-title">
                <h1>Dengerous Goods Regulation (DGR) Initial Category 3</h1>
            </div>
            <div class="breadcrumb">
                <ul>
                    <li><a href="{{ asset('/') }}">Home</a> </li>
                    <li><a href="#">Dengerous Goods Regulation (DGR) Initial Category 3</a> </li>
                </ul>
            </div>
        </div>
    </section>
                    ...
                    <div id="blog" class="single-post">
                        <div class="post-item">
                            <div class="post-item-wrap">
                                ...
                                <br>
                                <p style="text-align: justify;"><strong>DANGEROUS GOODS REGULATION (DGR) INITIAL CATEGORY 3:</strong></p>
                                <p style="text-align: justify;">
                                    This course is designed for freight forwarder staff who either have no prior DGR training
                                     or who have not updated their training during the past 24 months. This course fulfills 
                                     ICAO and IATA training requirements and qualifies you to handle and process dangerous 
                                     goods for carriage of by air for a 24-month period.
                                    </p>
                                    ...
                                    <br>
                                     ...
                                     <li>Apply the IATA DGR to common work situations  </span></li>
                                     <li>Understand related legal aspects and responsibilities of shippers, agents, and airlines</span></li>
                                     <li>Identify dangerous goods permitted for transport and their DGR categories</span></li>
                                     <li>Pack, mark, and label dangerous goods</span></li>
                                     <li>Complete a Shipper’s Declaration for dangerous goods</span></li>
                                     <li>Follow general emergency procedures when a damaged package is discovered</span></li>
                                    <br>
                                    ...
                                    <br>
                                     ...
                                     <li>Freight Forwarder staff preparing DG / HAZMAT shipments</span></li>
                                    ...
                                    <br>
                                     ...
                                     <p style="text-align: justify;"><span style="font-size: 12.16px;"><a href="https://www.iata.org/en/training/courses/dgr-initial-cat3/288/en/">https://www.iata.org/en/training/courses/dgr-initial-cat3/288/en/</a></span></p>
