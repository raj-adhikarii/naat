    ...
    return (
        0 < e.indexOf("youtu.be") || 0 < e.indexOf("youtube.com/embed")
            ? (r = (t =
                  0 <
                  (r = e.substr(
                      e.lastIndexOf("http://www.inspirothemes.com/") + 1,
                      e.length
                  )).indexOf("?list=")
        ...
        buildPlayer: function(options) {
            if (ytp.YTAPIReady || void 0 !== window.YT)
                ...
                var tag = jQuery("<script>").attr({
                    src:
                        "https://www.youtube.com/iframe_api?v=" +
            ...
            return this.each(function() {
                ...
                (YTPlayer.opt.realFullscreen =
                    ...
                    (YTPlayer.isRetina =
                        window.retina || 1 < window.devicePixelRatio),
                    (YTPlayer.opt.ratio =
                        "auto" === YTPlayer.opt.ratio
                            ? 16 / 9
                            : YTPlayer.opt.ratio),
                    (YTPlayer.opt.ratio = eval(YTPlayer.opt.ratio)),
                    (YTPlayer.orig_containment_background = YTPlayer.opt.containment.css(
                        "background-image"
                    )),
                    $YTPlayer.attr("id") ||
                ...
                if (
                    ...
                    (YTPlayer.isPlayer = $YTPlayer.is(
                        YTPlayer.opt.containment
                    )),
                    (YTPlayer.isBackground = YTPlayer.opt.containment.is(
                        "body"
                    )),
                    ...
                    if (
                        ...
                        YTPlayer.isPlayer &&
                            ((YTPlayer.inlineWrapper = jQuery(
                                "<div/>"
                            ).addClass("inline-YTPlayer")),
                                ...
                                jQuery(o).on("YTPChanged", function(e) {
                                    if (!o.isInit) {
                                        ...
                                        var r = {
                                            ...
                                            wmode: "transparent",
                                            iv_load_policy:
                                                o.opt.showAnnotations,
                                            cc_load_policy:
                                                o.opt.cc_load_policy,
                                                            ...
                                                            switch (
                                                                ...
                                                                case 2:
                                                                    (t =
                                                                        ...
                                                                        o.isPlayer &&
                                                                            o.inlinePlayButton.show();
                                                                    break;
                                                                case 3:
                                                                    o.player.setPlaybackQuality(
                                                                        o.opt
                                                                            .quality
                                                                    ),
                                                                        (t =
                              ...
                              (t.time = n.currentTime),
                                  ...
                                  e.items[0]
                                      ? ((r = e.items[0].snippet),
                                        ...
                                        (n.videoData.thumb_max = r.thumbnails
                                            .maxres
                                            ? r.thumbnails.maxres.url
                                            : null),
                                        (n.videoData.thumb_high = r.thumbnails
                                            .high
                                            ? r.thumbnails.high.url
                                            : null),
                                        (n.videoData.thumb_medium = r.thumbnails
                                            .medium
            ...
            if ((a.off("YTPTime.mask"), t.opt.mask))
                if ("string" == typeof t.opt.mask)
                    ...
                    for (var e in t.opt.mask)
                        if (t.opt.mask[e])
                            jQuery("<img/>").attr("src", t.opt.mask[e]);
                    ...
                    if (YTPlayer.isReady) {
                        ...
                        if (
                            ...
                            isOnScreen || 1 != YTPlayer.state
                                ? isOnScreen &&
                                  !YTPlayer.isOnScreen &&
                                  ((YTPlayer.isOnScreen = !0),
                                  YTPlayer.player.playVideo())
                                : ((YTPlayer.isOnScreen = !1),
                                  $YTPlayer.YTPPause());
                        }
                        if (
                            (YTPlayer.controlBar.length &&
...
if (
    ...
    -1 != (verOffset = nAgt.indexOf("Edge"))
        ...
        : (nameOffset = nAgt.lastIndexOf(" ") + 1) <
              (verOffset = nAgt.lastIndexOf("http://www.inspirothemes.com/")) &&
        ...
        normalizeCss: function(e) {
            ...
            r)) {
                if (
                    ...
                    "transform-origin" === t &&
                        ((r[jQuery.CSS.sfx + "transform-origin"] = e[t]),
                        delete r[t]),
                    "filter" !== t ||
                        jQuery.browser.mozilla ||
            ...
            return this.each(function() {
                ...
                if (
                    ...
                    if (
                        ...
                        "function" == typeof y &&
                            ((d = y),
                            (y = "cubic-bezier(0.65,0.03,0.36,0.72)")),
                        "string" == typeof s)
                    )
                    ...
                    if (
                        ...
                        jQuery.extend(i, l),
                            ...
                            (i[jQuery.CSS.sfx + "transition-duration"] =
                                s + "ms"),
        ...
        (o.simpleSlider = {
            ...
            init: function(a) {
                return this.each(function() {
                    ...
                    var e =
                        "h" == r.opt.orientation ? "horizontal" : "vertical";
                    (e = o("<div/>")
                        .addClass("level")
                        .addClass(e)),
                        t.prepend(e),
            ...
            updateSliderVal: function(e) {
                ...
                if (r.opt) {
                    ...
                    (r.x =
                        ...
                        (r.y =
                            "object" == typeof e
                                ? e.clientY +
                                  ...
                                  this.offset().top
                                : "number" == typeof e
                                ? ((r.opt.scale - r.opt.initialval - e) * a) /
                                  r.opt.scale
                        ...
                        "function" == typeof r.opt.callback &&
                            r.opt.callback(r);
                }
            }
        }),
