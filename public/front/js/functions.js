...
(function($) {
        ...
        equalize: function() {
            ...
            if ($equalize.length > 0) {
                $equalize.each(function() {
                    var elem = $(this),
                        selectorItem =
                            elem.find(elem.attr("data-equalize-item")) ||
                            "> div",
                        maxHeight = 0;
    ...
    INSPIRO.header = {
        ...
        stickyHeader: function() {
            ...
            $(window).breakpoints("greaterEqualTo", "lg", function() {
                if (
                    !$header.is(".header-disable-fixed, .header-always-fixed")
                ) {
                    if (scrollOnTop > $headerOffsetTop + shrinkHeader) {
                        $header.addClass("header-sticky");
                        if (
                            scrollOnTop >
                            $headerOffsetTop + shrinkHeaderActive
                        ) {
        ...
        mainMenu: function() {
            if ($mainmenu.length > 0) {
                ...
                $("#mainMenu-trigger button").on("click", function(e) {
                ...
                $(window).breakpoints("greaterEqualTo", "lg", function() {
                    var $menuLastItem = $("nav > ul > li:last-child"),
                        ...
                        $menuLastInvert =
                            $menuLastItemUl.width() - $menuLastItem.width(),
                    ...
                    if (
                        $window.width() -
                            ($menuLastItemUl.width() +
                                $menuLastItem.offset().left) <
                        0
                    ) {
        ...
        onepageMenu: function() {
            if ($mainmenu.hasClass("menu-one-page")) {
                ...
                $(window).on("scroll", function() {
                    ...
                    $mainmenu
                        .find(
                            'nav > ul > li > a[href="#' + $currentSection + '"]'
                        )
                        .parent("li")
        ...
        currentSection: function() {
            ...
            $section.each(function() {
                ...
                if (
                    elem.offset().top - $window.height() / 3 <
                        $window.scrollTop() &&
                ...
                if (transparentHeader) {
                    if (sliderFullscreen) {
                        ...
                        if (!$header.attr('data-transparent="true"')) {
                            elem.find($sliderClassSlide).css(
                                "padding-top",
                                screenHeightExtra + "px"
                            );
                        }
                        if (!customHeight) {
                            $.each(sliderTargetElements, function(
                                index,
                                divElem
                            ) {
                                divElem.css(
                                    "height",
                                    $(window).height() / screenRatio + "px"
                                );
                            });
                        } else {
                            $.each(sliderTargetElements, function(
            ...
            if ($inspiroSlider.length > 0) {
                ...
                $inspiroSlider.each(function() {
                    var elem = $(this),
                        ...
                        carouselSmartSpeed =
                            elem.attr("data-smart-speed") || 500,
                    ...
                    if (elem.find(".slide").length > 1) {
                        elem.owlCarousel({
                            ...
                            autoplay:
                                carouselAutoPlay == "false" ? false : true,
                            autoplayTimeout: Number(carouselAutoplayTimeout),
                            autoplayHoverPause:
                                carouselHoverPause == "false" ? false : true,
                            ...
                            onInitialize: function(event) {
                                var t = setTimeout(function() {
                                    elem.find(
                                        ".owl-item:not(.active) .slide > video"
                                    ).each(function() {
                                        this.pause();
                                    });
                                    elem.find(
                                        ".owl-item.active .slide .kenburns-bg"
        ...
        owlCarousel: function() {
            if ($carousel.length > 0) {
                ...
                $carousel.each(function() {
                    ...
                    elem.responsive = {
                        0: { items: Number(elem.options.itemsXs) },
                        420: { items: Number(elem.options.itemsSm) },
                        768: { items: Number(elem.options.itemsMd) },
                        992: { items: Number(elem.options.itemsLg) },
                        1200: { items: Number(elem.options.items) }
                    };
                    elem.owlCarousel({
                        nav: elem.options.nav == "false" ? false : true,
                        ...
                        itemElement: elem.options.itemElement,
                        autoplay:
                            elem.options.autoPlay == "false" ? false : true,
                        autoplayTimeout: elem.options.autoplayTimeout,
                        autoplayHoverPause:
                            elem.options.autoplayHoverPause == "true"
                                ? true
                                : false,
                        autoWidth:
                            elem.options.autoWidth == "true" ? true : false,
                    ...
                    elem.on("click", function() {
                        if (toggleItemClass) {
                            if (toggleItemClassTarget) {
                                $(toggleItemClassTarget).toggleClass(
                                    toggleItemClass
                                );
                            } else {
                    ...
                    if (elem.options.direction == "forward") {
                        new Waypoint({
                            ...
                            handler: function() {
                                var t = setTimeout(function() {
                                    elem.addClass(
                                        elem.options.animation + " visible"
                                    );
                                }, elem.options.delay);
                            },
                            offset: "100%"
            ...
            if ($parallax.length > 0) {
                ...
                $parallax.each(function() {
                    ...
                    if (
                        ...
                        $elem
                            .find(".parallax-container")
                            .scrolly({ bgParallax: true });
                    } else {
                        $elem
                            .find(".parallax-container")
                            .addClass("parallax-responsive");
                    }
                });
            }
        },
        ...
        gridLayout: function() {
            if ($gridLayout.length > 0) {
                ...
                $gridLayout.each(function() {
                    ...
                    elem.options = {
                        itemSelector:
                            elem.attr("data-item") || "portfolio-item",
                        layoutMode: elem.attr("data-layout") || "masonry",
                        stagger: elem.attr("data-stagger") || 0,
                        autoHeight: elem.attr("data-auto-height") || true,
                        gridMargin: elem.attr("data-margin") || 20,
                        transitionDuration:
                            elem.attr("data-transition") || "0.55s",
                    ...
                    elem.find("." + elem.options.itemSelector).css(
                        "padding",
                        "0 " +
                            elem.options.gridMargin +
                            "px " +
                    ...
                    if ($gridFilter.length > 0) {
                        $gridFilter.each(function() {
                            var elemFilter = $(this),
                                ...
                                elemFilterLayout = elemFilter.attr(
                                    "data-layout"
                                ),
                            ...
                            $filterItem.on("click", function() {
                                elemFilter
                                    .find("li")
                                    .removeClass($filterItemActiveClass);
                                $(this)
                                    .parent("li")
            ...
            if ($ytPlayer.length > 0) {
                ...
                $ytPlayer.each(function() {
                    ...
                    elem.options = {
                        ...
                        containment:
                            elem.attr("data-youtube-container") || "self",
                    ...
                    elem.YTPlayer({
                        ...
                        optimizeDisplay:
                            elem.options.optimizeDisplay == "false"
                                ? false
                                : true,
                        loop: elem.options.loop == "false" ? false : true,
                        ...
                        autoPlay:
                            elem.options.autoPlay == "true" ? true : false,
                        realfullscreen:
                            elem.options.realfullscreen == "true"
                                ? true
                                : false,
                        showYTLogo:
                            elem.options.showYTLogo == "true" ? true : false,
                        showControls:
                            elem.options.showControls == "true" ? true : false
                    });
                    if (!elem.options.autoPlay) {
                        elem.find("#youtube-background-controls").addClass(
                            "video-is-playing"
                        );
                    }
                    elem.on("YTPReady", function() {
                        $("#youtube-background-controls").on(
                            "click",
                            function() {
            ...
            if ($vmPlayer.length > 0) {
                ...
                $vmPlayer.each(function() {
                    var elem = $(this),
                        ...
                        elemQuality =
                            elem.attr("data-vimeo-quality") || "hd720",
                        elemOpacity = elem.attr("data-vimeo-opacity") || 1,
                        elemContainer =
                            elem.attr("data-vimeo-container") || "self",
                        ...
                        elemFullScreen =
                            elem.attr("data-vimeo-fullscreen") || true,
                        elemControls =
                            elem.attr("data-vimeo-controls") || false,
                        elemLogo = elem.attr("data-vimeo-logo") || false,
                        elemAutoPause =
                            elem.attr("data-vimeo-autopause") || false;
                    elem.vimeo_player({
                        videoURL: elemVideo,
                        mute: elemMute,
                        ratio: elemRatio,
            ...
            if ($modal.length > 0) {
                $modal.each(function() {
                    var elem = $(this),
                        ...
                        elemCookieExpire =
                            elem.attr("data-cookie-expire") || 365,
                        elemCookieName =
                            elem.attr("data-cookie-name") || "coockieName",
                        elemCookieEnabled =
                            elem.attr("data-cookie-enabled") || "false";
                ...
                $modalStrip.each(function() {
                    var elem = $(this),
                        ...
                        elemCookieExpire =
                            elem.attr("data-cookie-expire") || 365,
                        elemCookieName =
                            elem.attr("data-cookie-name") || "coockieName2013",
                        elemCookieEnabled =
                            elem.attr("data-cookie-enabled") || "false";
                    if (elem.hasClass(modalShow)) {
                        var modalElem = $(this);
                    ...
                    if (elem.hasClass("cookie-notify")) {
                        var timeout = setTimeout(function() {
                            if (elemCookieEnabled != true) {
                                ...
                                if (
                                    typeof Cookies.get(elemCookieName) ==
                                    "undefined"
                                ) {
                                    cookieNotify.addClass(modalShowClass);
                                }
        ...
        sidebarFixed: function() {
            ...
            if ($sidebarFixed.length > 0) {
                ...
                $sidebarFixed.each(function() {
                    ...
                    elem.options = {
                        additionalMarginTop:
                            elem.attr("data-margin-top") || 120,
                        additionalMarginBottom:
                            elem.attr("data-margin-bottom") || 50
                    };
                    elem.theiaStickySidebar({
                        additionalMarginTop: Number(
                            elem.options.additionalMarginTop
                        ),
                        additionalMarginBottom: Number(
                            elem.options.additionalMarginBottom
                        )
                    });
                });
            }
                    ...
                    clipboardType.each(function() {
                        var elem = $(this),
                            title =
                                ...
                                "Copy to clipboard",
                            titleSuccess =
                                elem.attr("data-original-title-success") ||
                                "Copied!";
            ...
            if ($widget_twitter.length > 0) {
                ...
                var t = setTimeout(function() {
                    $widget_twitter.each(function() {
                        var $elem = $(this),
                            twitterUsername =
                                $elem.attr("data-username") || "ardianmusliu",
                            twitterLimit = $elem.attr("data-limit") || 2,
                            twitterDateFormat =
                                $elem.attr("data-format") || "%b/%d/%Y",
                            twitterLoadingText =
